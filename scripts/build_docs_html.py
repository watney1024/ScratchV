...
COURSE = {
    ...
    "sections": [
        ...
        },
        {
            ...
            "title": "入门模块",
            "icon": "🔰",
            "desc": "汇编美化、日志、错误提示、CFG、指令计数、窥孔优化、指令调度",
            "docs": [
        ...
        },
        {
            ...
            "title": "中级模块",
            "icon": "📗",
            "desc": "DSL 增强、ONNX 解析、IR 系统、优化器、指令选择、寄存器分配等",
            "docs": [
        ...
        },
        {
            ...
            "title": "高级模块",
            "icon": "📕",
            "desc": "IR 验证、LLVM Standalone、Cache 模型、Spike 仿真、CI Dashboard",
            "docs": [
                ...
                {"file": "docs/topics/23-Cache模型.md", "num": "23", "title": "Cache 模型"},
                {"file": "docs/topics/24-Spike仿真.md", "num": "24", "title": "Spike 仿真集成"},
                {"file": "docs/topics/25-LLVM对比工具.md", "num": "25", "title": "LLVM 对比工具"},
                {"file": "docs/topics/26-TinyFive对比.md", "num": "26", "title": "TinyFive 对比工具"},
                {"file": "docs/topics/28-扩展指令选择.md", "num": "28", "title": "扩展指令选择"},
                {"file": "docs/topics/30-CI-Dashboard.md", "num": "30", "title": "CI Dashboard"},
            ],
        },
    ],
}
