...
| 编号 | 模块 | 难度 | 状态 |
|------|------|------|------|
| [01](archive/topic01_dsl_enhancer_guide.md) | DSL 前端增强器（if/while） | 中级 | 📄 |
| [02](frontend_onnx_parser.md) | ONNX 解析器 | 中级 | 📄 |
| [03](03-IR系统.md) | 中间表示系统 (IR) | 中级 | ✅ |
| [04](optimizer_framework.md) | IR 优化器框架 | 中级 | 📄 |
| [06](archive/topic06_bench_suite_guide.md) | 编译器性能测试套件 | 中级 | 📄 |
| [08](08-指令选择.md) | 后端指令选择 | 中级 | ✅ |
| 10 | （预留） | — | ⬜ |
| [14](backend_const_merge.md) | 常量加载合并优化 | 中级 | 📄 |
| 15 | （预留） | — | ⬜ |
| [16](backend_llvm_codegen.md) | LLVM 代码生成后端 | 中级 | 📄 |
| [17](backend_regalloc_linear.md) | 寄存器分配（线性扫描） | 中级 | 📄 |
...
| 文件 | 说明 |
|------|------|
| [frontend_onnx_parser.md](frontend_onnx_parser.md) | ONNX 模型解析器 |
| [ir_system.md](ir_system.md) | IR 系统（旧版）→ 新版见 [03-IR系统.md](03-IR系统.md) |
| [optimizer_framework.md](optimizer_framework.md) | 优化器框架（5 passes） |
...
| [backend_regalloc_linear.md](backend_regalloc_linear.md) | 寄存器分配（线性扫描） |
| [backend_llvm_codegen.md](backend_llvm_codegen.md) | LLVM IR 代码生成 |
