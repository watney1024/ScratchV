...
| [06](06-性能基准套件.md) | 编译器性能测试套件 | 入门 | ✅ |
| [23](23-Cache模型.md) | Cache 行为分析 | 入门 | 看懂缓存命中率 |
| [30](30-CI-Dashboard.md) | 性能仪表盘 (Dashboard) | 入门 | 看懂性能对比 |
| [24](24-Spike仿真.md) | Spike 仿真集成 | 入门 | 跑仿真看结果 |
| [25](25-LLVM对比工具.md) | LLVM vs ScratchV 对比 | 入门 | 看懂双路径差距 |
| [26](26-TinyFive对比.md) | TinyFive 对比工具 | 入门 | 看懂指令级对比 |
| [27](27-RV32全量Benchmark.md) | RV32 全量 Benchmark | 入门 | 看懂统一ISA对比 |
...
| [04](04-IR优化器框架.md) | IR 优化器框架（5 passes） | 中级 | ✅ |
| [08](08-指令选择.md) | 后端指令选择 | 中级 | ✅ |
| [14](14-常量加载合并.md) | 常量加载合并优化 | 中级 | ✅ |
...
| 编号 | 模块 | 难度 | 状态 |
|------|------|------|------|
| [21](21-IR验证器.md) | IR 验证器（7条规则） | 高级 | ✅ |
| [22](22-Standalone-LLVM编译器.md) | Standalone LLVM 编译器 | 高级 | ✅ |
| [28](28-扩展指令选择.md) | 扩展指令选择 (F/D/abs/sqrt) | 高级 | ✅ |
| 29 | （预留） | — | ⬜ |
...
| [backend_inst_select_ext.md](archive/backend_inst_select_ext.md) | 扩展指令选择（旧版）→ 新版见 [28](28-扩展指令选择.md) |
...
| [backend_const_merge.md](archive/backend_const_merge.md) | 常量合并（旧版）→ 新版见 [14](14-常量加载合并.md) |
| [standalone_riscv_compiler.md](standalone_riscv_compiler.md) | Standalone RISC-V（旧版）→ 新版见 [19](19-Standalone-RISC-V编译器.md) |
| [standalone_llvm_compiler.md](archive/standalone_llvm_compiler.md) | Standalone LLVM（旧版）→ 新版见 [22](22-Standalone-LLVM编译器.md) |
