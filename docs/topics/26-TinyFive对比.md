# Topic 26 — TinyFive 对比工具

> **难度**: 高级 | **源文件**: `scratchv/standalone/tinyfive_compare.py`
...
# 输出 JSON
python scratchv/standalone/tinyfive_compare.py --json output/tinyfive.json
```
...
machine.load_asm(inner_loop_asm_lines)

# 执行一轮 MAC
machine.run(n=20)  # 限制 20 条指令

# 查看统计
machine.print_perf()
print(f"Instructions executed: {machine.instr_count}")
```
...
- 相关 topic: [Topic 24 — Spike 仿真](24-Spike仿真.md) | [Topic 19 — Standalone RISC-V](19-Standalone-RISC-V编译器.md)
