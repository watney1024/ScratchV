...
> **难度**：中 | **类型**：参考分析 | **源文件**：`scratchv/backend/instruction_select.py`, `scratchv/backend/inst_select_ext.py`
> **状态**：✅ 已完成
...
指令选择器负责将**平台无关的 IR 指令**翻译为**RISC-V 特定的机器指令**。
...
- 相关 topic: [课题3 — IR 系统](03-IR系统.md) | [课题17 — 寄存器分配](17-寄存器分配.md) | [课题28 — 完善后端指令选择](28-扩展指令选择.md)
